...
func main() {
	...
	http.ListenAndServeTLS("43.143.169.111:2003", ca.Path("server.crt"), ca.Path("server.key"), nil)
	http.ListenAndServe("43.143.169.111:2003", nil)
}
